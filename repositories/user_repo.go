...
func GetUserByEmail(email string) (*models.User, error) {
	...
	query := `SELECT id, username, email, password FROM users WHERE email = $1` // Specify columns explicitly makes it clearer and avoids issues if table schema changes
